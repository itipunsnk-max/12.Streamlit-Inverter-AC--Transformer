...
class InstallationAssessment:
    """Budgetary installation-band result; it is not utility approval."""

    status: AssessmentStatus
    installation_type: str | None
    rule_id: str | None
    transformer_count: int
    rating_kva: Decimal | None
    pad_dimensions_m: tuple[Decimal, Decimal] | None
    yard_dimensions_m: tuple[Decimal, Decimal] | None
    earth_conductor_length_m: Decimal | None
    earth_rod_count: int | None
    findings: tuple[Finding, ...]
...
class TransformerSelection:
    ...
    findings: tuple[Finding, ...]
    decision: DecisionRecord
    installation_assessment: InstallationAssessment | None = None
